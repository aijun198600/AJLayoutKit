...
public extension UIView {
    @discardableResult
    public func width(_ width: AJValue) -> UIView {
    ...
    @discardableResult
    public func height(_ height: AJValue) -> UIView {
    ...
    @discardableResult
    public func size(_ value: AJValue) -> UIView {
        self.width(value)
        self.height(value)
        return self
    }
    ...
    @discardableResult
    public func size(_ width: AJValue, _ height: AJValue) -> UIView {
        self.width(width)
        self.height(height)
        return self
    }
    ...
    @discardableResult
    public func maxWidth(_ width: AJValue) -> UIView {
        let left = AJLayoutAttribute(self, attribute: .width)
    ...
    @discardableResult
    public func minWidth(_ width: AJValue) -> UIView {
        let left = AJLayoutAttribute(self, attribute: .width)
    ...
    @discardableResult
    public func maxHeight(_ height: AJValue) -> UIView {
        let left = AJLayoutAttribute(self, attribute: .height)
    ...
    @discardableResult
    public func minHeight(_ height: AJValue) -> UIView {
        let left = AJLayoutAttribute(self, attribute: .height)
    ...
    @discardableResult
    public func maxSize(_ value: AJValue) -> UIView {
        self.maxWidth(value)
    ...
    @discardableResult
    public func minSize(_ value: AJValue) -> UIView {
        self.minWidth(value)
    ...
    @discardableResult
    public func maxSize(_ width: AJValue, _ height: AJValue) -> UIView {
        self.maxWidth(width)
    ...
    @discardableResult
    public func minSize(_ width: AJValue, _ height: AJValue) -> UIView {
        self.minWidth(width)
